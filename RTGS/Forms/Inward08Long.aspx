<%@ Page Title="" Language="C#" MasterPageFile="~/Client.Master" AutoEventWireup="true" CodeBehind="Inward08Long.aspx.cs" Inherits="RTGS.Forms.Inward08Long" %>
                    ...
                    <div class="panel panel-info">
                        <div class="panel-body" id="ButtonPanel" runat="server" visible="false">
                            ...
                            <div style="float:left;margin-left:40px">
                                    <asp:Button ID="btnCancelTrans" Text="Cancel" runat="server" CssClass="btn btn-success" OnClick="btnCancelTrans_Click" /></div>
                            <%--<div style="float:left;margin-left:40px">
                                 <asp:Button ID="btnTransfer" Text="Retry" runat="server" CssClass="btn btn-danger" OnClick="btnTransfer_Click"  /></div>--%>
                            <div style="float:left;margin-left:10px">
                                    <asp:Button ID="btnApprove" Text="Approve" runat="server" CssClass="btn btn-success" OnClick="btnApprove_Click"  /></div>
                             <div style="float:left;margin-left:10px">
                                 <asp:TextBox ID="txtNewAccountNo" runat="server" Width="300px" placeholder="Enter New Account No. here: Max17Text" Visible="false" CssClass="form-control-small" /></div>
                        </div>
                    </div>
        </div>
    </div>
