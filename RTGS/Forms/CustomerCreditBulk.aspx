<%@ Page Title="" Language="C#" MasterPageFile="~/Client.Master" AutoEventWireup="true" CodeBehind="CustomerCreditBulk.aspx.cs" Inherits="RTGS.CustomerCreditBulk" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   <div class="row" style="font-weight:bold;margin-top:55px" >
        <div class="col-md-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><b>FI To FI Customer Credit Transfer(Bulk)</b></h3>
                </div>
