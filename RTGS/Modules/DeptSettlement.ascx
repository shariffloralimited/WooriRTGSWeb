<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="false" CodeBehind="DeptSettlement.ascx.cs" Inherits="RTGS.modules.DeptSettlement" %>
  <div class="row">
    <div class="col-md-12">
        <div class="table-responsive" style="height:125px;overflow-y:scroll">
             ...
             <asp:GridView ID="SettlementGrid" runat="server" CssClass=" table  table-bordered table-striped table-hover margin-bottome-0" 
               ...
               <Columns>
                   <asp:BoundField  DataField = "Name" HeaderText="Dept"       ItemStyle-Width ="140px"  ItemStyle-HorizontalAlign="Left"    HeaderStyle-HorizontalAlign="Left" />
