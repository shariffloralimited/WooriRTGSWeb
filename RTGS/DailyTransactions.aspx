<%@ Page Title="Daily Transactions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DailyTransactions.aspx.cs" Inherits="RTGS.DailyTransactions" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <asp:DropDownList ID="StatusList" Width="130px" CssClass="form-control" runat="server">
                                ...
                                <asp:ListItem Text="Rej/Cancel" Value="2" />
                                 <asp:ListItem Text="Reversed" Value="3" />
                                <asp:ListItem Text="CBSFailed" Value="4" />
                    ...
                    <div class="row">
                     ...
                     <div class="table-responsive">
                         <asp:DataGrid ID="BatchChecksGrid" runat="server" AutoGenerateColumns="false"  FooterStyle-Font-Bold="true"
                             ...
                             <Columns>
                                 <asp:BoundColumn DataField = "FormName"        HeaderStyle-BackColor="#c0c0c0" HeaderText="Trans Type" />
                                 <asp:BoundColumn DataField = "MsgId"           HeaderStyle-BackColor="#c0c0c0" HeaderText="Msg ID" />
                                 <asp:BoundColumn DataField = "SttlmDt"         HeaderStyle-BackColor="#c0c0c0" HeaderText="Stlmnt Date" />
                                 <asp:BoundColumn DataField = "Branch"          HeaderStyle-BackColor="#c0c0c0" HeaderText="Branch" />
                                 ...
                                 <asp:BoundColumn DataField = "StatusName"      HeaderStyle-BackColor="#c0c0c0" HeaderText="Status" />
                                   <asp:BoundColumn DataField = "OrginatorACType"      HeaderStyle-BackColor="#c0c0c0" HeaderText="OrgACType" />
                                   <asp:BoundColumn DataField = "ReceiverACType"      HeaderStyle-BackColor="#c0c0c0" HeaderText="RecACType" />
                                   <asp:BoundColumn DataField = "PurposeOfTransaction"      HeaderStyle-BackColor="#c0c0c0" HeaderText="Purpose" />
                                   <asp:BoundColumn DataField = "OtherInfo"      HeaderStyle-BackColor="#c0c0c0" HeaderText="OtherInfo" />
                             </Columns>
                         </asp:DataGrid>
                            </div>
                        </div>
